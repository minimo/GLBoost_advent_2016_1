...
phina.namespace(function() {
    phina.define('sample.SplashScene', {
        ...
        init: function() {
            ...
            //preload asset
            var assets = sample.Application.assets["preload"];
            ...
            texture.load(sample.SplashScene.logo).then(function() {
                this._init();
            }.bind(this));
            ...
            texture2.load(sample.SplashScene.logo_glb).then(function() {
                this._init();
            }.bind(this));
